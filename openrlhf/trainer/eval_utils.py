# This is copied from https://github.com/deepseek-ai/DeepSeek-Math for math correctness reward.
...
from openrlhf.trainer.answer_extraction import extract_answer, extract_program_output, strip_string
